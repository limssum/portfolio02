...
<body>
    ...
    style="text-align:center">                                                                                     
        ...
        <input type="button" onClick="location.href='ID_search.html'" class="btn_two" value="아이디 찾기" />
        <input type="button" onClick="location.href='PW_search.html'" class="btn_three" value="비밀번호 찾기" />
      </form>
